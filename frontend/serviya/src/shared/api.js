...
export const metricsApi = {
    ...
    getClientTagMetrics: (clientId) => request(`/api/v1/clients/${clientId}/tag-metrics`, { auth: true }),
    getOffererTagMetrics: (offererId) => request(`/api/v1/offerers/${offererId}/tag-metrics`, { auth: true }),
};

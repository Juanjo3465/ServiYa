...
/**
 * Salida web (Response) de una etiqueta del catalogo de resenas de servicio. GET /api/v1/service-review-tags.
 * Mapea desde el dominio ServiceReviewTagCatalog.
 */
@Schema(description = "Etiqueta del catalogo de resenas de servicio")
public record ServiceReviewTagResponse(
        Long id,
        String tagName,

...
public interface ServiceRequestApi {
    ...
    ResponseEntity<Page<ServiceRequestResponse>> getClientRequests(List<String> statuses, Pageable pageable);

    @Operation(summary = "Listar las solicitudes propias como oferente",
            description = "Filtrables por estados. RF-016, RF-020, RF-039.")
    @ApiResponse(responseCode = "200", description = "Pagina de solicitudes")
    ResponseEntity<Page<ServiceRequestResponse>> getOffererRequests(List<String> statuses, Pageable pageable);
    ...
    ResponseEntity<Void> markNotProvided(Long id);
